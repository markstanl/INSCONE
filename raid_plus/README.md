...
python raid_plus/pipeline.py --dataset raid --mode debug
python raid_plus/pipeline.py --dataset m4   --mode debug

# full run — all prompts, all models, Parquet output
python raid_plus/pipeline.py --dataset raid --mode full
python raid_plus/pipeline.py --dataset m4   --mode full

# specific models only
python raid_plus/pipeline.py --dataset raid --mode full --models gemini-3.1-pro deepseek-v3

# with RAID adversarial attacks
git clone https://github.com/liamdugan/raid.git
export RAID_REPO=/path/to/raid
python raid_plus/pipeline.py --dataset raid --mode full --attacks homoglyph whitespace

# upload to HuggingFace after generation
python raid_plus/pipeline.py --dataset raid --mode full --hf-repo mabb123/raid-modern-llms
```
